...
<Quiz 
  question="Why didn't the upstream breakers trip and stop the fire?"
  options={[
    "The breakers were undersized for the total 10,000 W load.",
    "The GFCI didn't sense the current imbalance.",
    "Thermal runaway at a high-resistance termination produces heat without an overcurrent.",
    "The transfer switch mechanically jammed and prevented the breaker from operating."
  ]}
  correctAnswerIndex={2}
  explanation="The total 10,000 W heating load draws approximately 41.6 A at 240 V, which is well within the 100 A rating of the emergency panel and its upstream breaker. A standard thermal-magnetic breaker protects against overcurrent (pulling more amps than the wire is rated for) and short circuits (a sudden, massive fault). It does not detect high-resistance heating at a specific joint. As the loose termination's resistance increased, it acted like a small heating element right at the lug, melting the metal without ever pulling enough total current to trip the 100 A breaker."
/>
