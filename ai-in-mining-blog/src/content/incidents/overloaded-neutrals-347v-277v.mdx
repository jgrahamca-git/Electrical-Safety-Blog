...
tags: ["Power Quality", "Harmonics", "Lighting", "Fire Hazard", "CEC", "MWBC", "LED Retrofit"]
...
### 1. The 347V / 277V Trap

Almost every Canadian commercial and industrial building wired between 1970 and 2015 runs interior lighting on 600Y/347V multi-wire branch circuits — three single-phase branches sharing one neutral. The US analog at 480Y/277V uses 277V lighting on the same MWBC topology. Copper saved at install. Supposed to be efficient.
...
At 347V line-to-neutral, **an open neutral on an energized MWBC turns the neutral into a hot conductor**. A worker contacting it completes a path to ground at 347V — a fatality risk, not just a fire risk. Newer practice and guidance requires pigtailing the neutral at every device on a 347V MWBC so neutral continuity is independent of any individual device.

277V on a 480Y/277V system carries the same risks at slightly lower voltage. Public reporting documents an apprentice electrocuted contacting an energized 277V conductor on a high-rise build, and a journeyman who survived contacting an open 277V ballast neutral only because the shock threw him clear of the ladder. The auto-transformer inside an older 277V ballast creates a series voltage rise across the open neutral that turns contact into a fatality risk.
...
Eight specific actions, in order of priority for any E&I professional working on Canadian or US wye systems with nonlinear lighting or electronic loads:
...
- **Verify MWBC neutral pigtailing on every 347V branch.** The hazard if it's missing is electrocution, not just fire.
...
The eight actions above are condensed into a printable field checklist — *347V/277V LED Retrofit Neutral Audit Field Checklist*. Five sections covering True-RMS measurement procedure, harmonic spectrum capture, conductor and transformer thermal check, MWBC pigtailing verification, and a sign-off block for the work order. Built for E&I professionals walking into a panel where an LED retrofit happened in the last ten years and nobody re-enginered/designed the system afterward.
...
LINKEDIN DRAFT
Hook: An East Coast power-quality crew clamped a True-RMS meter onto a transformer neutral and read 100% third-harmonic content with only 17% fundamental. The fire didn't happen — the transformers got swapped before it did.

Setup: When neutrals melt down in industrial plants, the post-incident meeting always blames the giant three-phase drives. Standard 6-pulse VFDs don't connect to the neutral. Their 5th and 7th order harmonics circulate in the phase conductors. They aren't the suspect.

Core: The triplens that cook neutrals come from the LED drivers and SMPS loads no one audits — single-phase nonlinear loads on shared neutrals stack arithmetically as zero-sequence current. On Canadian 347V lighting and US 277V lighting both, the multi-wire branch circuit topology concentrates that current on a single neutral that nobody re-sized when the retrofit happened.

Takeaway: An energy-saving LED retrofit can re-engineer fire risk into your panel overnight. Measure your neutral with a True-RMS meter. The phase ammeter is lying.

CTA: Have you measured neutral current on a 347V or 277V lighting panel after an LED retrofit, and what did you find?

Link: [Blog Link]
Hashtags: #PowerQuality #Harmonics #ElectricalSafety #IndustrialMaintenance #LEDLighting #CEC
*/}
