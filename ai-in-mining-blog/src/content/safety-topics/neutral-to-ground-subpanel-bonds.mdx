...
LINKEDIN POST DRAFT:
Hook: Is that green bonding screw left inside your sub-panel? You might have just turned your metal conduits into live neutral return paths.
Setup: Codes mandate that the neutral and ground conductors are bonded at a single point—the main service. Downstream in sub-panels, they must remain isolated.
Core Failure: Installing a bonding jumper in a sub-panel parallels the neutral and ground. Unbalanced return current now flows continuously through the ground wire, metal conduit, and enclosures.
Takeaway: This "objectionable current" creates severe noise on instruments and, worse, a lethal shock hazard if the main neutral wire ever breaks.
CTA: Do your preventative maintenance PMs include checking grounding conductors for objectionable current?
Hashtags: #ElectricalSafety #GroundingAndBonding #NationalElectricalCode #Subpanels #JourneymanElectrician
*/}
