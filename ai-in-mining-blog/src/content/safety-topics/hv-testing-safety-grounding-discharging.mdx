...
LINKEDIN POST DRAFT:
Hook: You turned off the Hi-Pot tester and the screen reads zero. Is the cable safe to touch? Not by a long shot.
Setup: Long power cables and large windings behave like giant capacitors, storing electrical charge during high-voltage Megger and Hi-Pot testing (often up to 80kV).
Core Failure: Unplugging test leads or briefly shorting the wire is not enough. Due to "dielectric absorption," the insulation slowly recovers its charge after the ground is removed, building back up to lethal voltages.
Takeaway: Follow the 4x rule: keep the safety ground connected for four times the test duration. Always use a current-limiting discharge hot stick and leave grounds on until final connection.
CTA: What safety grounding protocols does your crew enforce after performing high-voltage testing?
Hashtags: #HVTesting #ElectricalSafety #HighVoltage #Megger #HiPot #SubstationSafety
*/}
